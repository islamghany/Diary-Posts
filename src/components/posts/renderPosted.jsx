...
class RenderPosted extends React.Component {
  handlelove(noteid) {
  ...
  render() {
    ...
    if (note && this.props.currentUser) {
      return (
        ...
        l-28.285-28.285l3.862-3.854c7.798-7.798,20.486-7.798,28.284,0C447.399,325.656,447.399,338.344,439.615,346.13z"
          ...
          <div className="result">
            ...
            <div
              className="share"
              onClick={() => this.props.renderModelOfUser(note, "shared")}
            >
              <span className="heading font-ty icno">
                {note["shared"] ? Object.keys(note["shared"]).length : 0}
              </span>{" "}
              <span className="heading font-ty alt">share</span>{" "}
            </div>
          </div>
          <ul className="post__interactions">
            ...
            >
              <div className="post__interactions-share">
